...
const translations = {
  ...
  zh: {
    ...
    'privacy.s1.body': '<p>GR Link（以下简称"本应用"或"我们"）是由 Jackson Wang 独立开发的第三方 iOS 应用，对本应用处理的任何数据承担个人信息处理者责任。联系方式：<a href="mailto:gr-link@liljackson.org" class="text-neu-accent-dark hover:underline">gr-link@liljackson.org</a>。</p><p class="mt-3">GR Link 与株式会社理光（Ricoh Company, Ltd.）及理光映像有限公司（Ricoh Imaging Company, Ltd.）无任何从属、授权、合作或赞助关系。</p>',
